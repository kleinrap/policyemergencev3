...
def initial_values(inputs_dict, experiment_input, run_number, agent_inputs, AS_theory, PF_theory):
	...
	for i in range(externalparties_number):
		...
		if affiliation == 0:
			# Main beliefs
			belieftree[0][0][1] = 0 		# PC1
			belieftree[0][1][1] = 0 		# PC2
			belieftree[0][2][1] = 0 		# ML1
			belieftree[0][3][1] = 0			# ML2
			belieftree[0][4][1] = 0 		# ML3
			belieftree[0][5][1] = 0 		# ML4
			belieftree[0][6][1] = 0 		# S1
			belieftree[0][7][1] = 0 		# S2
			belieftree[0][8][1] = 0 		# S3
			belieftree[0][9][1] = 0 		# S4
			belieftree[0][10][0] = 0		# S5
			belieftree[0][11][0] = 0		# S6
			belieftree[0][12][0] = 0		# S7
			belieftree[0][13][0] = 0		# S8
			belieftree[0][14][0] = 0		# S9
			belieftree[0][15][0] = 0		# S10
			# Causal relations PC1-2 - ML1-4
			belieftree[0][16][0] = 0
			belieftree[0][17][0] = 0
			belieftree[0][18][0] = 0
			belieftree[0][19][0] = 0
